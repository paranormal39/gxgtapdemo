...
var ASM_CONSTS = {
  6645600: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 6645661: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 6645725: function() {return Module.webglContextAttributes.powerPreference;},  
 6645783: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 6645838: function($0) {performance.now = function() { return $0; };},  
 6645886: function($0) {performance.now = function() { return $0; };},  
 6645934: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _HISPLAYERUnity_ChangeControlInstance(value) {
      multiView.changeControlInstance(value);
    }

  function _HISPLAYERUnity_ChangeVideoContent(url, resumePosition, ads) {
      return multiView.changeVideoContent(UTF8ToString(url), resumePosition, UTF8ToString(ads));
    }

  function _HISPLAYERUnity_CheckLicenseError(cb) {
      multiView.checkLicenseError().then(function (errorCode) {
        dynCall_vi(cb, errorCode);
      });    
    }

  function _HISPLAYERUnity_CheckWatermark(cb) {
      multiView.checkWaterMark().then(function (watermark) {
        dynCall_vi(cb, watermark);
      });    
    }

  function _HISPLAYERUnity_DisableABR() {
      multiView.disableABR();
    }

  function _HISPLAYERUnity_EnableABR() {
      multiView.enableABR();
    }

  function _HISPLAYERUnity_ErrorQueueIsEmpty() {
      return isErrorQueueEmpty();
    }

  function _HISPLAYERUnity_EventQueueIsEmpty() {
      return isEventQueueEmpty();
    }

  function _HISPLAYERUnity_GetAdCurrentTime() {
      return multiView.getAdCurrentTime();
    }

  function _HISPLAYERUnity_GetAdDuration() {
      return multiView.getAdDuration();
    }

  function _HISPLAYERUnity_GetAdRemainingTime() {
      return multiView.getAdRemainingTime();
    }

  function _HISPLAYERUnity_GetCurrentTime() {
      return multiView.getCurrentTime();
    }

  function _HISPLAYERUnity_GetDuration() {
      return multiView.getDuration();
    }

  function _HISPLAYERUnity_GetErrorPlayerIndex() {
      return getErrorPlayerIndex();
    }

  function _HISPLAYERUnity_GetErrorType() {
      return getErrorType();
    }

  function _HISPLAYERUnity_GetEventPlayerIndex() {
      return getEventPlayerIndex();
    }

  function _HISPLAYERUnity_GetEventType() {
      return getEventType();
    }

  function _HISPLAYERUnity_GetIsDurationLimitReady() {
  	return getIsDurationLimitReady();
    }

  function _HISPLAYERUnity_GetJsonFormattedError() {
  ...
  function _HISPLAYERUnity_GetJsonFormattedEvent() {
  ...
  function _HISPLAYERUnity_GetMultistreamContentInfoInt(elementIndex, info_index) {
      return multiView.getContentInfo(elementIndex, info_index);
    }

  function _HISPLAYERUnity_GetPlaybackDurationLimit() {
  	return getPlaybackDurationLimit();
    }

  function _HISPLAYERUnity_GetTrackBitrate(index) {
      return multiView.getTrackBitrate(index);
    }

  function _HISPLAYERUnity_GetTrackCount() {
      return multiView.getTrackCount();
    }

  function _HISPLAYERUnity_GetTrackHeight(index) {
      return multiView.getTrackHeight(index);
    }

  function _HISPLAYERUnity_GetTrackID(index) {
  ...
  function _HISPLAYERUnity_GetTrackWidth(index) {
      return multiView.getTrackWidth(index);
    }

  function _HISPLAYERUnity_Init(url, serverKey) {
      setUpContext(GL);
    }

  function _HISPLAYERUnity_InitializeMultistream(hisPlayerKey, sdkVersion) {
      multiView.Initialize(UTF8ToString(hisPlayerKey), UTF8ToString(sdkVersion));
    }

  function _HISPLAYERUnity_IsLive() {
      return multiView.isLive();
    }

  function _HISPLAYERUnity_Log(level, message) {
      Logger.getInstance().log(level, UTF8ToString(message));
    }

  function _HISPLAYERUnity_Pause() {
      multiView.pause();
    }

  function _HISPLAYERUnity_Release() {
      multiView.release();
    }

  function _HISPLAYERUnity_Resume() {
      multiView.resume();
    }

  function _HISPLAYERUnity_Seek(milliseconds) {
      multiView.seek(milliseconds);
    }

  function _HISPLAYERUnity_SetMultiAdsProperties(
      index,
      adsMode,
      assetKey,
      contentSrcId,
  ...
  function _HISPLAYERUnity_SetMultiPaths(index, path, autoPlayback, loopPlay, disableABR, manifestTimeout, segmentsTimeout, startingBitrate) {
  ...
  function _HISPLAYERUnity_SetMultistream() {
      if (window.multiView) {
        multiView.release();
      }
  ...
  function _HISPLAYERUnity_SetMultistreamVolume(value) {
      multiView.setVolume(value);
    }

  function _HISPLAYERUnity_SetTrack(idx) {
      multiView.setCurrentTrack(idx);
    }

  function _HISPLAYERUnity_Stop() {
      multiView.stopPlayer();
    }

  function _HISPLAYERUnity_updateMultistreamVideoTexture(textureId, elementIndex, textureWidth, textureHeight) {
...
var asmLibraryArg = {
  ...
  "HISPLAYERUnity_ChangeControlInstance": _HISPLAYERUnity_ChangeControlInstance,
  "HISPLAYERUnity_ChangeVideoContent": _HISPLAYERUnity_ChangeVideoContent,
  "HISPLAYERUnity_CheckLicenseError": _HISPLAYERUnity_CheckLicenseError,
  "HISPLAYERUnity_CheckWatermark": _HISPLAYERUnity_CheckWatermark,
  "HISPLAYERUnity_DisableABR": _HISPLAYERUnity_DisableABR,
  "HISPLAYERUnity_EnableABR": _HISPLAYERUnity_EnableABR,
  "HISPLAYERUnity_ErrorQueueIsEmpty": _HISPLAYERUnity_ErrorQueueIsEmpty,
  "HISPLAYERUnity_EventQueueIsEmpty": _HISPLAYERUnity_EventQueueIsEmpty,
  "HISPLAYERUnity_GetAdCurrentTime": _HISPLAYERUnity_GetAdCurrentTime,
  "HISPLAYERUnity_GetAdDuration": _HISPLAYERUnity_GetAdDuration,
  "HISPLAYERUnity_GetAdRemainingTime": _HISPLAYERUnity_GetAdRemainingTime,
  "HISPLAYERUnity_GetCurrentTime": _HISPLAYERUnity_GetCurrentTime,
  "HISPLAYERUnity_GetDuration": _HISPLAYERUnity_GetDuration,
  "HISPLAYERUnity_GetErrorPlayerIndex": _HISPLAYERUnity_GetErrorPlayerIndex,
  "HISPLAYERUnity_GetErrorType": _HISPLAYERUnity_GetErrorType,
  "HISPLAYERUnity_GetEventPlayerIndex": _HISPLAYERUnity_GetEventPlayerIndex,
  "HISPLAYERUnity_GetEventType": _HISPLAYERUnity_GetEventType,
  "HISPLAYERUnity_GetIsDurationLimitReady": _HISPLAYERUnity_GetIsDurationLimitReady,
  "HISPLAYERUnity_GetJsonFormattedError": _HISPLAYERUnity_GetJsonFormattedError,
  "HISPLAYERUnity_GetJsonFormattedEvent": _HISPLAYERUnity_GetJsonFormattedEvent,
  "HISPLAYERUnity_GetMultistreamContentInfoInt": _HISPLAYERUnity_GetMultistreamContentInfoInt,
  "HISPLAYERUnity_GetPlaybackDurationLimit": _HISPLAYERUnity_GetPlaybackDurationLimit,
  "HISPLAYERUnity_GetTrackBitrate": _HISPLAYERUnity_GetTrackBitrate,
  "HISPLAYERUnity_GetTrackCount": _HISPLAYERUnity_GetTrackCount,
  "HISPLAYERUnity_GetTrackHeight": _HISPLAYERUnity_GetTrackHeight,
  "HISPLAYERUnity_GetTrackID": _HISPLAYERUnity_GetTrackID,
  "HISPLAYERUnity_GetTrackWidth": _HISPLAYERUnity_GetTrackWidth,
  "HISPLAYERUnity_Init": _HISPLAYERUnity_Init,
  "HISPLAYERUnity_InitializeMultistream": _HISPLAYERUnity_InitializeMultistream,
  "HISPLAYERUnity_IsLive": _HISPLAYERUnity_IsLive,
  "HISPLAYERUnity_Log": _HISPLAYERUnity_Log,
  "HISPLAYERUnity_Pause": _HISPLAYERUnity_Pause,
  "HISPLAYERUnity_Release": _HISPLAYERUnity_Release,
  "HISPLAYERUnity_Resume": _HISPLAYERUnity_Resume,
  "HISPLAYERUnity_Seek": _HISPLAYERUnity_Seek,
  "HISPLAYERUnity_SetMultiAdsProperties": _HISPLAYERUnity_SetMultiAdsProperties,
  "HISPLAYERUnity_SetMultiPaths": _HISPLAYERUnity_SetMultiPaths,
  "HISPLAYERUnity_SetMultistream": _HISPLAYERUnity_SetMultistream,
  "HISPLAYERUnity_SetMultistreamVolume": _HISPLAYERUnity_SetMultistreamVolume,
  "HISPLAYERUnity_SetTrack": _HISPLAYERUnity_SetTrack,
  "HISPLAYERUnity_Stop": _HISPLAYERUnity_Stop,
  "HISPLAYERUnity_updateMultistreamVideoTexture": _HISPLAYERUnity_updateMultistreamVideoTexture,
...
/** @type {function(...*):?} */
var dynCall_viiiiiijjii = Module["dynCall_viiiiiijjii"] = createExportWrapper("dynCall_viiiiiijjii");
...
/** @type {function(...*):?} */
var dynCall_fdii = Module["dynCall_fdii"] = createExportWrapper("dynCall_fdii");
...
unexportedRuntimeFunction('socketState', false);
unexportedRuntimeFunction('socketState__user', false);
unexportedRuntimeFunction('core', false);
unexportedRuntimeFunction('core__user', false);
